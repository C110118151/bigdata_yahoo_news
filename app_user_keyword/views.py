...
# global variable
# df = pd.read_csv('dataset/yahoo_news_preprocessed_5days.csv', sep='|')

# (2) we can load data using reload_df_data() function
def load_df_data():
    # df is a global variable
    global  df
    df = pd.read_csv('app_user_keyword/dataset/yahoo_news_preprocessed_2m.csv', sep='|')
...
news_categories = ['全部','意外事故','突發事故','車禍事故','國道車禍','重大車禍事故','旅遊事故','工安意外','北市事故']
...
print("app_user_keyword was loaded!--人物聲量載入成功")
