...
SECRET_KEY = "django-insecure-ji7@l^=$04y_afu%2q^d432&9gq@2ys1#s(2&_v-6)a#h8d2&i"
...
INSTALLED_APPS = [
    ...
    "django_extensions",
    "app_top_keyword",
    "app_top_person",  # our first app is added here
    "app_user_keyword",
    "app_jiang",
    "core",
...
TEMPLATES = [
    {
        ...
        ],  # this is the path to our templates
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
